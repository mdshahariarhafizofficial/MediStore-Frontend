        ...
        <header className="h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 z-30">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3 pl-4 border-l border-gray-200 dark:border-gray-800">
               <div className="h-9 w-9 rounded-full bg-gradient-to-br from-primary-100 to-primary-200 dark:from-primary-900 dark:to-primary-800 flex items-center justify-center font-bold text-primary-700 dark:text-primary-300 shadow-sm border border-primary-100 dark:border-primary-700">
                 {user?.name?.charAt(0).toUpperCase()}
               </div>
               <div className="hidden md:block text-left">
                  <p className="text-sm font-bold text-gray-900 dark:text-white leading-tight">{user?.name}</p>
                  <p className="text-[10px] uppercase font-bold text-primary-600 tracking-wider">Administrator</p>
               </div>
            </div>
          </div>
        </header>
